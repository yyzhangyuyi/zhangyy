...
public class showCourse extends JFrame implements ActionListener {
    private static final long serialVersionUID = 1L;
    JTable table;
    DefaultTableModel model;

    public showCourse() {
        JFrame frame = new JFrame("考试安排查询（点击表头可切换升降序）");
        ...
        if (t <= 0) {
            JOptionPane.showMessageDialog(null, "暂无考试信息！！！");
